...
class QualificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create qualification" do
    assert_difference('Qualification.count') do
      post qualifications_url, params: { qualification: { amount_spent: @qualification.amount_spent, client_id: @qualification.client_id, note: @qualification.note, restaurant_id: @qualification.restaurant_id } }
    end
  ...
  test "should update qualification" do
    patch qualification_url(@qualification), params: { qualification: { amount_spent: @qualification.amount_spent, client_id: @qualification.client_id, note: @qualification.note, restaurant_id: @qualification.restaurant_id } }
